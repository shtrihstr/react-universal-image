            ...
            if (typeof placeholder === 'string') {
                var _ret = function () {
                    ...
                    if (_this4.props.blur > 0) {
                        return {
                            v: [_react2.default.createElement('img', _extends({ key: 1, style: { display: 'none' } }, attributes)), _react2.default.createElement('canvas', { key: 2, style: style })]
                        };
                    } else {
...
Image.propTypes = {
    ...
    'blur': _react2.default.PropTypes.bool,
